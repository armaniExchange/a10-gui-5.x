  ...
  constructor(props, context) {
    ...
    this.state = {
      ...
      collapse: {
        ...
        extras: this.routeActive([ 'mailbox', 'timeline', 'calendar', 'invoice', 'search', 'todo', 'profile' ]),
        blog: this.routeActive([ 'blog-list', 'blog-post', 'blog-articles', 'blog-article-view' ]),
        ecommerce: this.routeActive([ 'ecommerce-orders', 'ecommerce-order-view', 'ecommerce-products', 'ecommerce-product-view' ]),
                  ...
                  <ul className="nav">
                      ...
                      <li className={ this.routeActive([ 'forum-categories', 'forum-topics', 'forum-discussion' ]) ? 'active' : '' }>
                          <div className="nav-item" title="Forum" onClick={ this.toggleItemCollapse.bind(this, 'forum') }>
                              <em className="fa fa-sticky-note"></em>
                              <span>Forum</span>
                          </div>
